 ...
 */
        ...
        bekle(6);
        //Hello World! Yazının sitede oldugunu test et //oldugunu dedıgı ıcın assertequals aldık

        WebElement helloWorldText = driver.findElement(By.xpath("(//h4)[2]"));

        //Locate ını aldıgımız hellloWordlText webelementıni görunur olana kadar explicit Wait ile bekleyeceğim.
        ...
        //assertrue icerıyomu gorunuyo mu kullanırız
        //isdisplay locate alıp gorunur oldugunu test ederız
        //
